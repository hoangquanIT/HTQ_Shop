...
import com.quanht.dto.WebPaymentDto;
import com.quanht.request.PaymentRequest;
import com.quanht.service.OrderService;
import com.quanht.utils.VNPayConfig;
...
public class WebPaymentController {
    ...
    @Autowired
    public WebPaymentController(OrderService orderService) {
        this.orderService = orderService;
    }

    @PostMapping("/ecommerce/api/v1/client/payment")
...
//        vnp_Params.put("vnp_Inv_Type", req.getParameter("cbo_inv_type"));
        ...
        String vnp_SecureHash = VNPayConfig.hmacSHA512("ZXAFRSGVHLYJQVGDNEMXFSUTURRWVDOM", hashData.toString());
...
//        resp.getWriter().write(gson.toJson(job));
    ...
    @GetMapping("/ecommerce/api/v1/client/payment/order/{id}")
    public ResponseEntity<?> getOrderInfo(@PathVariable String id) {
        return ResponseEntity.ok(orderService.getOrderInfoAfterPayment((id)));
    }
